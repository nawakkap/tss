...
describe FilmsController do
  ...
  let(:valid_attributes) { { "film_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved film as @film" do
        ...
        post :create, {:film => { "film_id" => "invalid value" }}, valid_session
        assigns(:film).should be_a_new(Film)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested film" do
        ...
        Film.any_instance.should_receive(:update_attributes).with({ "film_id" => "MyString" })
        put :update, {:id => film.to_param, :film => { "film_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the film as @film" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Film.any_instance.stub(:save).and_return(false)
        put :update, {:id => film.to_param, :film => { "film_id" => "invalid value" }}, valid_session
        assigns(:film).should eq(film)
      end
